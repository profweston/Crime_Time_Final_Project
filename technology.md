...
Pandas has been used to clean the data and perform an exploratory analysis. Along with pandas, the datetime library as well as numpy were loaded for the cleaning and exploratory analysis.  The group tried to use a new library that was not covered during class called geopy.  Further analysis will be completed using Python.
